export const youtubeSettings = {
  ...
  Home: [
    ...
    { id: 'yt-homeshorts-toggle', label: 'Hide Shorts', type: 'checkbox', default: true, rating: 3 },
  ...
  Pages: [
    ...
    { id: 'yt-pagesshorts-toggle', label: 'Hide Shorts', type: 'checkbox', default: true, rating: 3 },
